            ...
            </div>
            {
                modal && <div className='w-full h-full flex items-center justify-center absolute top-0 left-0 bg-gray-100 opacity-70'>
                    <form className='w-[400px] flex flex-col gap-4 relative' onSubmit={handleSubmit}>
                        <div onClick={()=> setModal(false)} className='absolute -top-16 right-0 w-8 h-8 cursor-pointer rounded-full bg-gray-500 text-white flex items-center justify-center'><i class="ri-close-large-fill"></i></div>
